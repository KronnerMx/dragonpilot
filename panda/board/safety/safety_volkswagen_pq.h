...
const SteeringLimits VOLKSWAGEN_PQ_STEERING_LIMITS = {
  ...
  .max_rt_delta = 188,             // 6 max rate up * 50Hz send rate * 250000 RT interval / 1000000 = 75 ; 125 * 1.5 for safety pad = 113
  .max_rt_interval = 250000,       // 250ms between real time checks
  .max_rate_up = 10,                // 3.0 Nm/s RoC limit (EPS rack has own soft-limit of 5.0 Nm/s)
