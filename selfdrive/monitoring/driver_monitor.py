...
class DRIVER_MONITOR_SETTINGS():
  def __init__(self, DT_DMON=DT_DMON):
    ...
    self._AWARENESS_PRE_TIME_TILL_TERMINAL = 600.
    self._AWARENESS_PROMPT_TIME_TILL_TERMINAL = 240.
    ...
    self._MAX_TERMINAL_ALERTS = 999  # not allowed to engage after 3 terminal alerts
    self._MAX_TERMINAL_DURATION = int(1 / self._DT_DMON)  # not allowed to engage after 30s of terminal alerts
